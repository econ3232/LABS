...
#Questions
#1 They are not equivalent, whatever is first in the statement determines what the geometry will be, as stations are point data and counties are polygons. This affects the data since the first data has its attributes preserved and the second one is changed depending on overlap.
#2 Most of this lab was challenging for me, it was mostly looking at the things done in class and in the book and trying to change and utilize it to get an output. Almost all of this is new for me as I have not done any coding in R before.
#3 I would like to be able to determine spatial stats relating to social issues, like detrmining income issues relaterd to health, etc. 
